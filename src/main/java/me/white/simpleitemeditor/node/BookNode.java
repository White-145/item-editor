...
public class BookNode implements Node {
    public static final CommandSyntaxException ISNT_BOOK_EXCEPTION = new SimpleCommandExceptionType(Text.translatable("commands.edit.book.error.isntbook")).create();
    ...
    private enum Generation {
        ORIGINAL("commands.edit.book.generationoriginal"),
        COPY("commands.edit.book.generationcopy"),
        COPY_OF_COPY("commands.edit.book.generationcopyofcopy"),
        TATTERED("commands.edit.book.generationtattered");

        final String translationKey;

        Generation(String translationKey) {
    ...
    public void register(LiteralCommandNode<FabricClientCommandSource> rootNode, CommandRegistryAccess registryAccess) {
        ...
        LiteralCommandNode<FabricClientCommandSource> authorGetNode = ClientCommandManager
                ...
                .executes(context -> {
                    ...
                    if (!isBook(stack)) throw ISNT_BOOK_EXCEPTION;
        ...
        LiteralCommandNode<FabricClientCommandSource> generationGetNode = ClientCommandManager
                ...
                .executes(context -> {
                    ...
                    context.getSource().sendFeedback(Text.translatable(OUTPUT_GENERATION_GET, Text.translatable(Generation.values()[generation].translationKey)));
                    return generation;
                })
                .build();
        ...
        ArgumentCommandNode<FabricClientCommandSource, Generation> generationSetGenerationNode = ClientCommandManager
                ...
                .executes(context -> {
                    ...
                    if (oldGeneration == generation.ordinal()) throw GENERATION_ALREADY_IS_EXCEPTION;
                    ItemUtil.setBookGeneration(stack, generation.ordinal());
