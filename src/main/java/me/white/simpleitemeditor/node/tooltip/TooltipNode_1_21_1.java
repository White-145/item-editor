...
import me.white.simpleitemeditor.argument.enums.TooltipPartArgumentType_1_21_1;
...
public class TooltipNode_1_21_1 implements Node {
    ...
    public <S extends CommandSource> CommandNode<S> register(CommonCommandManager<S> commandManager, CommandRegistryAccess registryAccess) {
        ...
        CommandNode<S> getPartNode = commandManager.argument("part", TooltipPartArgumentType_1_21_1.tooltipPart()).executes(context -> {
            ItemStack stack = EditorUtil.getCheckedStack(context.getSource());
            TooltipPart part = TooltipPartArgumentType_1_21_1.getTooltipPart(context, "part");
        ...
        CommandNode<S> setPartNode = commandManager.argument("part", TooltipPartArgumentType_1_21_1.tooltipPart()).build();
