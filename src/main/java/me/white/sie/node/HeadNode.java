...
public class HeadNode implements Node {
    private static final CommandSyntaxException ISNT_HEAD_EXCEPTION = new SimpleCommandExceptionType(Component.translatable("commands.edit.head.error.isnthead")).create();
    private static final CommandSyntaxException NO_TEXTURE_EXCEPTION = new SimpleCommandExceptionType(Component.translatable("commands.edit.head.error.notexture")).create();
    private static final CommandSyntaxException TEXTURE_ALREADY_IS_EXCEPTION = new SimpleCommandExceptionType(Component.translatable("commands.edit.head.error.texturealreadyis")).create();
    private static final CommandSyntaxException OWNER_ALREADY_IS_EXCEPTION = new SimpleCommandExceptionType(Component.translatable("commands.edit.head.error.owneralreadyis")).create();
    private static final CommandSyntaxException INVALID_URL_EXCEPTION = new SimpleCommandExceptionType(Component.translatable("commands.edit.head.error.invalidtexture")).create();
    private static final CommandSyntaxException BAD_CUSTOM_TEXTURE_EXCEPTION = new SimpleCommandExceptionType(Component.translatable("commands.edit.head.error.texturecustombad")).create();
    private static final CommandSyntaxException TOO_FAST_EXCEPTION = new SimpleCommandExceptionType(Component.translatable("commands.edit.head.error.texturecustomtoofast")).create();
    private static final DynamicCommandExceptionType SERVER_ERROR_EXCEPTION = new DynamicCommandExceptionType(code -> Component.translatable("commands.edit.head.error.texturecustomservererror", code));
    private static final CommandSyntaxException NO_SOUND_EXCEPTION = new SimpleCommandExceptionType(Component.translatable("commands.edit.head.error.nosound")).create();
    private static final CommandSyntaxException SOUND_ALREADY_IS_EXCEPTION = new SimpleCommandExceptionType(Component.translatable("commands.edit.head.error.soundalreadyis")).create();
    private static final CommandSyntaxException TIMEOUT_EXCEPTION = new SimpleCommandExceptionType(Component.translatable("commands.edit.head.error.timeout")).create();
    ...
    private static GameProfile getProfile(ItemStack stack) {
        ...
        return stack.get(DataComponents.PROFILE).partialProfile();
    }
    ...
    private static void setProfile(ItemStack stack, Property profile) {
        ...
        stack.set(DataComponents.PROFILE, ResolvableProfile.createResolved(new GameProfile(UUID.randomUUID(), "*siehead", new PropertyMap(multimap))));
    }

    private static void setProfile(ItemStack stack, String owner) {
        stack.set(DataComponents.PROFILE, ResolvableProfile.createUnresolved(owner));
    }
    ...
    private static boolean hasSound(ItemStack stack) {
        return stack.has(DataComponents.NOTE_BLOCK_SOUND);
    }
    ...
    public static void setFromUrl(String url, SharedSuggestionProvider source) {
        try {
            ...
            EditorUtil.sendFeedback(source, Component.translatable(OUTPUT_TEXTURE_CUSTOM_OK));
        } catch (IOException e) {
            throw new RuntimeException(e);
        } catch (CommandSyntaxException e) {
            EditorUtil.sendError(source, Component.literal(e.getMessage()));
        }
    }
    ...
    public <S extends SharedSuggestionProvider> CommandNode<S> register(CommonCommandManager<S> commandManager, CommandBuildContext registryAccess) {
        ...
        CommandNode<S> getNode = commandManager.literal("get").executes(context -> {
            ...
            EditorUtil.sendFeedback(context.getSource(), Component.translatable(OUTPUT_TEXTURE_GET, TextUtil.url(texture)));
        ...
        CommandNode<S> setOwnerOwnerNode = commandManager.argument("owner", StringArgumentType.word()).executes(context -> {
            ...
            EditorUtil.sendFeedback(context.getSource(), Component.translatable(OUTPUT_OWNER_SET, owner));
            return Command.SINGLE_SUCCESS;
        }).build();
        ...
        CommandNode<S> setTextureTextureNode = commandManager.argument("texture", StringArgumentType.greedyString()).executes(context -> {
            ...
            if (uri.getHost().equals("textures.minecraft.net")) {
                ...
                EditorUtil.setStack(context.getSource(), stack);
                EditorUtil.sendFeedback(context.getSource(), Component.translatable(OUTPUT_TEXTURE_SET, TextUtil.url(texture)));
            } else {
                EditorUtil.sendFeedback(context.getSource(), Component.translatable(OUTPUT_TEXTURE_CUSTOM_SET, TextUtil.url(texture)));
        ...
        CommandNode<S> removeNode = commandManager.literal("remove").executes(context -> {
            ...
            EditorUtil.setStack(context.getSource(), stack);
            EditorUtil.sendFeedback(context.getSource(), Component.translatable(OUTPUT_TEXTURE_REMOVE));
            return Command.SINGLE_SUCCESS;
        }).build();
        ...
        CommandNode<S> soundGetNode = commandManager.literal("get").executes(context -> {
            ...
            EditorUtil.sendFeedback(context.getSource(), Component.translatable(OUTPUT_SOUND_GET, sound));
            return Command.SINGLE_SUCCESS;
        }).build();

        CommandNode<S> soundSetNode = commandManager.literal("set").build();

        CommandNode<S> soundSetSoundNode = commandManager.argument("sound", RegistryArgumentType.registryEntry(Registries.SOUND_EVENT, registryAccess)).executes(context -> {
            EditorUtil.checkCanEdit(context.getSource());
            ItemStack stack = EditorUtil.getCheckedStack(context.getSource()).copy();
            if (!isHead(stack)) {
                throw ISNT_HEAD_EXCEPTION;
            }
            SoundEvent sound = RegistryArgumentType.getRegistryEntry(context, "sound", Registries.SOUND_EVENT);
            ...
            EditorUtil.setStack(context.getSource(), stack);
            EditorUtil.sendFeedback(context.getSource(), Component.translatable(OUTPUT_SOUND_SET, id));
            return Command.SINGLE_SUCCESS;
        }).build();
        ...
        CommandNode<S> soundRemoveNode = commandManager.literal("remove").executes(context -> {
            ...
            EditorUtil.setStack(context.getSource(), stack);
            EditorUtil.sendFeedback(context.getSource(), Component.translatable(OUTPUT_SOUND_REMOVE));
            return Command.SINGLE_SUCCESS;
        }).build();
