...
public class SheepNode implements Node {
    private static final CommandSyntaxException ISNT_SHEEP_EXCEPTION = new SimpleCommandExceptionType(Component.translatable("commands.edit.mob.sheep.error.isntsheep")).create();
    private static final CommandSyntaxException COLOR_ALREADY_IS_EXCEPTION = new SimpleCommandExceptionType(Component.translatable("commands.edit.mob.sheep.error.coloralreadyis")).create();
    private static final CommandSyntaxException NO_COLOR_EXCEPTION = new SimpleCommandExceptionType(Component.translatable("commands.edit.mob.sheep.error.nocolor")).create();
    ...
    private static boolean hasColor(ItemStack stack) {
        return stack.has(DataComponents.SHEEP_COLOR);
    }

    private static DyeColor getColor(ItemStack stack) {
        return stack.get(DataComponents.SHEEP_COLOR);
    }

    private static void setColor(ItemStack stack, DyeColor color) {
        stack.set(DataComponents.SHEEP_COLOR, color);
    }

    private static void removeColor(ItemStack stack) {
        stack.remove(DataComponents.SHEEP_COLOR);
    }
